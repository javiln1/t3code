...
import { TurnRecapReactor } from "../Services/TurnRecapReactor.ts";
...
describe("OrchestrationReactor", () => {
  ...
  it("starts provider ingestion, provider command, checkpoint, thread deletion, and turn recap reactors", async () => {
    ...
    runtime = ManagedRuntime.make(
      Layer.effect(OrchestrationReactor, makeOrchestrationReactor).pipe(
        ...
        Layer.provideMerge(
          Layer.succeed(TurnRecapReactor, {
            start: () => {
              started.push("turn-recap-reactor");
              return Effect.void;
            },
            drain: Effect.void,
          }),
